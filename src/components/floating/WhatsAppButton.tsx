...
export default function FloatingButtons() {
    ...
    const whatsappUrl = `https://wa.me/${personalInfo.whatsapp.replace(/[^0-9]/g, "")}`;
            ...
            <motion.a
                ...
                style={{
                    boxShadow: isHoveringWhatsApp
                        ...
                        : "0 10px 30px rgba(0, 0, 0, 0.3), 0 0 20px rgba(37, 211, 102, 0.3)",
                }}
            >
                {/* Ping animation */}
                <motion.div
                ...
                <motion.div
                    animate={{
                        rotate: isHoveringWhatsApp ? [0, -10, 10, -10, 0] : 0,
                    }}
                ...
                <AnimatePresence>
                    {isHoveringWhatsApp && (
                        <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            exit={{ opacity: 0, x: 10 }}
                            className="absolute right-full mr-3 top-1/2 -translate-y-1/2 px-3 py-1.5 rounded-lg bg-[#25D366] text-white text-sm whitespace-nowrap font-medium"
                        >
                            Chat on WhatsApp
                        </motion.div>
                    )}
